========================================================================
    STATISCHE BIBLIOTHEK: HighResolution-Projektübersicht
========================================================================

Dieses HighResolution-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Es wurden keine Quelldateien als Teil des Projekts erstellt.


HighResolution.vcxproj
...
HighResolution.vcxproj.filters
